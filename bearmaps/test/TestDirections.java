...
/**
 * Test of the written driving directions part of the assignment. This part of
 * the assignment is optional and not worth any credit, and these tests should
 * be thought of as just for fun.
 */
public class TestDirections {
    private static final String PATHS_FILE = "../library-su19/data/proj3_test_inputs/path_results.txt";
    private static final String RESULTS_FILE = "../library-su19/data/proj3_test_inputs/directions_results.txt";
    ...
    public void testRouteDirections() throws Exception {
        ...
        for (int i = 0; i < NUM_TESTS; i++) {
            ...
            for (int j = 0; j < actual.size(); j++) {
                ...
                assertEquals("Directions did not match", expectedDir.toString(), actualDir.toString());
            }
        }
    }
